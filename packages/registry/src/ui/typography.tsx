...
/**
 * shadcn's typography styles as components. Purely presentational — every
 * piece renders its natural HTML element with Lorre token classes, so prose
 * stays consistent across themes without a plugin.
 */
