...
export function themeToCss(theme: ResolvedTheme): string {
  ...
  out.push("  --animate-marquee-vertical: lorre-marquee-vertical 40s linear infinite;")
  ...
  out.push("  --animate-retro-grid: lorre-retro-grid 15s linear infinite;")
  out.push("  --animate-ripple-wave: lorre-ripple-wave 3s ease-out infinite;")
  out.push("  --animate-aurora: lorre-aurora 10s ease-in-out infinite alternate;")
  out.push("")
  ...
  out.push("  }")
  out.push("  @keyframes lorre-marquee-vertical {")
  out.push("    to { transform: translateY(-50%); }")
  out.push("  }")
  ...
  out.push("  }")
  out.push("  @keyframes lorre-retro-grid {")
  out.push("    from { transform: translateY(0); }")
  out.push("    to { transform: translateY(var(--retro-grid-cell, 60px)); }")
  out.push("  }")
  out.push("  @keyframes lorre-ripple-wave {")
  out.push("    0% { transform: translate(-50%, -50%) scale(1); }")
  out.push("    50% { transform: translate(-50%, -50%) scale(1.06); }")
  out.push("    100% { transform: translate(-50%, -50%) scale(1); }")
  out.push("  }")
  out.push("  @keyframes lorre-aurora {")
  out.push("    from { transform: translate(0, 0) scale(1); }")
  out.push("    to { transform: translate(12%, 10%) scale(1.15); }")
  out.push("  }")
  out.push("}", "")
